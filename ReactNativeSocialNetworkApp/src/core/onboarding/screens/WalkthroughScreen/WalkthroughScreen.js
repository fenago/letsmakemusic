...
const WalkthroughScreen = () => {
  ...
  const _onDone = () => {
    console.log('[WalkthroughScreen] _onDone called')
    console.log('[WalkthroughScreen] isDelayedLoginEnabled:', config?.isDelayedLoginEnabled)
    deviceStorage.setShouldShowOnboardingFlow('false')
    if (config?.isDelayedLoginEnabled) {
      console.log('[WalkthroughScreen] Navigating to MainStack')
      navigation.navigate('MainStack')
      return
    }
    console.log('[WalkthroughScreen] Navigating to LoginStack -> Welcome')
